...
export default function CreatListing() {
    ...
    async function onSubmit(e) {
        ...
        setLoading(false);
        toast.success("list has uploaded");
    ...
    return (
        <div className="creatListing">
            ...
            <form className="creatForm" onSubmit={onSubmit}>
                ...
                <input id="images" className="file" type="file" onChange={onChange} accept=".jpg, .png, .jpeg" multiple required />
                <button id="submit" type="submit" className="submitbtn">Creat listing</button>
